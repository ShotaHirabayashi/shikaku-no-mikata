...
export default function HeroSection({ totalPosts, totalCategories }: Props) {
  return (
    <section className="relative overflow-hidden">
      ...
      />
      {/* オーバーレイ（テキスト可読性確保） */}
      <div className="absolute inset-0 bg-white/60 dark:bg-gray-950/75" />
      ...
      <div className="relative mx-auto max-w-6xl px-4 pb-16 pt-20 md:pb-24 md:pt-32">
        ...
        <p className="mb-8 max-w-2xl text-lg leading-relaxed text-gray-600 dark:text-gray-300">
          「何か始めたい」を行動に変える第一歩。
          費用・難易度・学習期間をひと目で比較して、自分に合った資格を探せます。
        </p>

        <div className="mb-10 flex items-center gap-6 text-sm text-gray-500 dark:text-gray-400">
          <span>
