...
export default function HeroSection({ totalPosts, totalCategories }: Props) {
  return (
    <section className="border-b border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900">
      <div className="mx-auto flex max-w-6xl flex-col-reverse items-center gap-10 px-4 pb-14 pt-16 md:flex-row md:gap-14 md:pb-20 md:pt-24">
        {/* テキスト */}
        <div className="flex-1">
          <h1 className="mb-6 text-4xl font-extrabold leading-[1.3] tracking-tight text-gray-900 dark:text-white md:text-5xl lg:text-6xl">
            あなたにぴったりの
        ...
        <div className="w-full flex-shrink-0 md:w-[45%]">
          <Image
            src="/images/hero.png"
            alt="資格取得のイメージ — 本、ノート、お茶のある温かいワークスペース"
            width={640}
            height={384}
